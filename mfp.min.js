...
var twLSN = ['gengpit.com','www.gengpit.com','1034467911699601339_40107d0b85671faf57499d5d8329c185d032660f.blogspot.com'];
function cekLSN(value,arr){ var status = false; for(var i=0; i<arr.length; i++){ var name = arr[i]; if(name == value){ status = true; break; } } return status; } var hst = window.location.hostname; if(cekLSN(hst, twLSN) == false) { window.location.href = 'http://bit.ly/Toko-GengPit'; }
